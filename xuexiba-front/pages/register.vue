    ...
    <div class="sign-up-container">
      <el-form ref="userForm" :model="params">
        ...
        <p class="sign-up-msg">
          ...
          <a
            target="_blank"
            href="http://www.ludashi.com/cms/android/page/protocol.html"
            >用户协议及隐私条款</a
          >
        </p>
      </el-form>
      ...
      <div class="more-sign">
        ...
        <ul>
          <li>
            <a id="weixin" class="weixin" target="_blank" @click="dis()"
              ><i class="iconfont icon-weixin"
            /></a>
          </li>
          <li>
            <a id="qq" @click="dis()" class="qq" target="_blank"
...
import registerApi from "@/api/lar/register";
  ...
  methods: {
    ...
    timeDown() {
      let result = setInterval(() => {
        --this.second;
        this.codeTest = this.second + "后重新发送";
        if (this.second < 1) {
    ...
    getCodeFun() {
      if (this.sending === true) {
        if (
          this.params.mobile == "" ||
          !/^1[345789]\d{9}$/.test(this.params.mobile)
        ) {
          this.$message({
            type: "error",
            message: "请输入有效手机号！",
